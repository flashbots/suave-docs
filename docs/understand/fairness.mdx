...
4. Is fairness a worthwhile goal? 
    ...
    - _Intuitively, yes. Logically, we can ask, what does "fairness" really mean? If we extend the ideas on the [previous page](/learn/meaning), a fair environment could be one in which **your capacity to make meaning matches your buying power**._
