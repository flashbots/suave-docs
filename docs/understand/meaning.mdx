...
We established in the [introduction](/learn/intro) that MEV is a general phenomenon which arises from the time it takes to communicate. If communication is not instantaneous, then those who receive information first can act on it prior to anyone else. 
