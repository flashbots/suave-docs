...
<div className="intro-grid">
  <a href="/how-to/run-suave" className="introLink">
  ...
  <a href="/novel-use-cases" className="introLink">
    <div className="intro-block">
      <div className="intro-image">
        <svg
          xmlns="http://www.w3.org/2000/svg"
...
<div className="intro-grid">
  <a href="/how-to/create-contracts/" className="introLink">
    <div className="intro-block">
      <div className="intro-image">
        <svg
          xmlns="http://www.w3.org/2000/svg"
    ...
    <div className="intro-block">
      ...
      <div className="intro-text">
        ...
        <div className="intro-desc">
          Write native code to extend the EVM even more
        </div>
      </div>
    </div>
  </a>
...
<div className="intro-grid">
  <a href="https://collective.flashbots.net/c/suave/27" className="introLink">
    <div className="intro-block">
      <div className="intro-image">
        <svg
          xmlns="http://www.w3.org/2000/svg"
