...
3. Get your **[developer keys](/key-concepts/)**. These are _information-oriented_ and provide insight into why SUAVE works in the way that our guides and tutorials illustrate. These are for **application developers and ecosystem partners**.
4. Consult the **[technical specs](/technical/)**. These are also _information-oriented_ and provide you with up-to-date certainty about the software we provide. These are for **SUAVE contributors and integrators**.
5. Refine your **[understanding of MEV](/understand/)**. This section is _discussion-oriented_. It does not present "the right way", but rather encourages you to reflect on "the deep why", ideally in dialogue with friends. Why does it matter that we work on MEV?
...
<div>
  ...
  <map name="imagemap">
    ...
    <area shape="rect" coords="330,300,440,600" href="/key-concepts" alt="Key Concepts" />
    <area shape="rect" coords="460,300,600,600" href="/technical" alt="Technical Specs" />
  </map>
</div>
</AlignItems>
