...
SUAVE is currently in early alpha. The first testnet is called Rigil.<br/> Please be aware that your data will likely not persist and that it is neither fully confidential nor secure.<br/> Happy hacking!
...
<div className="intro-grid">
  ...
  <a href="/novel-use-cases" className="intro-link">
    <div className="intro-block">
      <div className="intro-image">
        <svg
          xmlns="http://www.w3.org/2000/svg"
      ...
      <div className="intro-text">
        <div className="intro-heading">Novel Use Cases</div>
        <div className="intro-desc">Get inspiration for what to build</div>
      </div>
    </div>
  </a>
</div>
  ...
  <a href="/how-to/create-contracts/" className="intro-link">
    <div className="intro-block">
      ...
      <div className="intro-text">
        ...
        <div className="intro-desc">Begin building better mechanisms</div>
      </div>
    </div>
  </a>
  <a href="/how-to/run-suave/" className="intro-link">
...
<div className="intro-grid">
  <a href="https://collective.flashbots.net/c/suave/27" className="intro-link">
    <div className="intro-block">
      ...
      <div className="intro-text">
        <div className="intro-heading">Discuss on our forum</div>
        <div className="intro-desc">Discuss new ideas with the community</div>
      </div>
    </div>
  </a>
  <a
    href="https://github.com/flashbots/suave-geth/blob/main/CONTRIBUTING.md"
    ...
    <div className="intro-block">
      ...
      <div className="intro-text">
        ...
        <div className="intro-desc">Read the code and work with us</div>
      </div>
    </div>
  </a>
</div>
