...
3. Learn the **[key concepts](/key-concepts/)**. These are _information-oriented_ and provide insight into why SUAVE works in the way that our guides and tutorials illustrate. These are our treasure maps.
4. Consult the **[technical specs](/technical/)**. These are also _information-oriented_ and provide you with up-to-date certainty about the software we provide. 
