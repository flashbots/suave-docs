...
You need not use precompiles in the ways which our examples illustrate. For instance, if you wish to restrict access to methods with a modifier requiring some confidential secret, you can do so in SUAVE. This can be achieved by following the below steps, contributed by Miha:
