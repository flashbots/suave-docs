...
Compile your contracts (from the root directory of your project):

```bash
yarn contracts:build 
```

Deploy the compile contracts (you need to have [SUAVE running locally](/tutorials/run-suave) for this to work):
