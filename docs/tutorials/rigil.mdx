...
There is a [community-maintained repo here](https://github.com/halo3mic/suave-alloy) if you like 🦀.

Clone to repo and run `cargo run --example submit_ccr` to see how CCRs can be created and submitted using Rust.