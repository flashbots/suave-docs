...
You can find good exampel contracts to learn from and test with in our [SUAPP examples repo](https://github.com/flashbots/suapp-examples/). Choose one of these and copy-paste it into your `src` directory. Then run:
