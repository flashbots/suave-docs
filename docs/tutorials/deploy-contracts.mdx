...
The local devnet we're using here funds a dev account for you by default, as well as setting up a Kettle for you to submit Confidential Compute Requests to when interacting with your contracts (coming up in the following tutorials). Your local address and the Kettle created for your local devnet are listed below:

#### Local dev account

- balance: 10 billion RETH
...
#### Local kettle account

- balance: 2^256 RETH
- address: `0xB5fEAfbDD752ad52Afb7e1bD2E40432A485bBB7F`
- private key: `0x6c45335a22461ccdb978b78ab61b238bad2fae4544fb55c14eb096c875ccfc52`