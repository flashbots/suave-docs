...
If you'd like to deploy one of these contracts to the Rigil Testnet instea, first ensure that you have rETH for the account you want to use from the [Rigil ETH Faucet](https://faucet.rigil.suave.flashbots.net).
