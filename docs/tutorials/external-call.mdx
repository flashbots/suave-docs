...
If you'd like to understand how the `spell` tool we have been using throughout these tutorials ServiceWorkerRegistration, you can read the [**Golang source code here**](https://github.com/flashbots/suave-geth/tree/main/cmd/geth/spellcmd).
