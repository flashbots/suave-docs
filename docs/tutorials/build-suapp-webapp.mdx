...
This tutorial will show you how to build a SUAPP web application using [`suave-viem`](https://www.npmjs.com/package/@flashbots/suave-viem), our [typescript SDK](/resources/typescript-sdk).
