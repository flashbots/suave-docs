...
1. I take my signed ETH L1 Uniswap tx, and put it inside a `confidentialComputeRequest`.
    ...
    2. I specify the MEVM node for whom the hint is encrypted.
...
3. They craft their backrun, and place _that transaction_ into another `confidentialComputeRequest`. 
