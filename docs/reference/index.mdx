...
2. **[Confidential computation](/reference/confidential-computation/index)** - what is is.
    1. **[Worked examples](/reference/confidential-computation/worked-examples)**.
    2. **[New APIs](/reference/confidential-computation/apis)**.
