...
### [isConfidential](https://github.com/flashbots/suave-std/tree/main/src/suavelib/Suave.sol#L173)
...
### [aesDecrypt](https://github.com/flashbots/suave-std/tree/main/src/suavelib/Suave.sol#L190)
...
### [aesEncrypt](https://github.com/flashbots/suave-std/tree/main/src/suavelib/Suave.sol#L203)
...
### [buildEthBlock](https://github.com/flashbots/suave-std/tree/main/src/suavelib/Suave.sol#L218)
...
### [buildEthBlockTo](https://github.com/flashbots/suave-std/tree/main/src/suavelib/Suave.sol#L237)
...
### [confidentialInputs](https://github.com/flashbots/suave-std/tree/main/src/suavelib/Suave.sol#L254)
...
### [confidentialRetrieve](https://github.com/flashbots/suave-std/tree/main/src/suavelib/Suave.sol#L267)
...
### [confidentialStore](https://github.com/flashbots/suave-std/tree/main/src/suavelib/Suave.sol#L280)
...
### [contextGet](https://github.com/flashbots/suave-std/tree/main/src/suavelib/Suave.sol#L290)
...
### [doHTTPRequest](https://github.com/flashbots/suave-std/tree/main/src/suavelib/Suave.sol#L302)
...
### [doHTTPRequest2](https://github.com/flashbots/suave-std/tree/main/src/suavelib/Suave.sol#L314)
...
- `httpResponse` ([HttpResponse](#httpresponse)): Response of the request.

### [ethcall](https://github.com/flashbots/suave-std/tree/main/src/suavelib/Suave.sol#L327)
...
### [extractHint](https://github.com/flashbots/suave-std/tree/main/src/suavelib/Suave.sol#L339)
...
### [fetchDataRecords](https://github.com/flashbots/suave-std/tree/main/src/suavelib/Suave.sol#L353)
...
### [fillMevShareBundle](https://github.com/flashbots/suave-std/tree/main/src/suavelib/Suave.sol#L365)
...
### [getInsecureTime](https://github.com/flashbots/suave-std/tree/main/src/suavelib/Suave.sol#L377)

Returns the current Kettle Unix time in milliseconds. Insecure because it assumes trust in Kettle's clock.

Output:

- `time` (`uint256`): Current Unix time in milliseconds.

### [newBuilder](https://github.com/flashbots/suave-std/tree/main/src/suavelib/Suave.sol#L388)
...
### [newDataRecord](https://github.com/flashbots/suave-std/tree/main/src/suavelib/Suave.sol#L403)
...
### [privateKeyGen](https://github.com/flashbots/suave-std/tree/main/src/suavelib/Suave.sol#L421)
...
### [randomBytes](https://github.com/flashbots/suave-std/tree/main/src/suavelib/Suave.sol#L433)
...
### [signEthTransaction](https://github.com/flashbots/suave-std/tree/main/src/suavelib/Suave.sol#L447)
...
### [signMessage](https://github.com/flashbots/suave-std/tree/main/src/suavelib/Suave.sol#L464)
...
### [simulateBundle](https://github.com/flashbots/suave-std/tree/main/src/suavelib/Suave.sol#L480)
...
### [simulateTransaction](https://github.com/flashbots/suave-std/tree/main/src/suavelib/Suave.sol#L493)
...
### [submitBundleJsonRPC](https://github.com/flashbots/suave-std/tree/main/src/suavelib/Suave.sol#L510)
...
### [submitEthBlockToRelay](https://github.com/flashbots/suave-std/tree/main/src/suavelib/Suave.sol#L527)
...
### [HttpResponse](https://github.com/flashbots/suave-std/tree/main/src/suavelib/Suave.sol#L77)

Description of an HTTP response.

- `status` (`uint64`): HTTP status code of the response.
- `body` (`bytes`): Body of the response.
- `error` (`bytes`): Error message if any.

### [SimulateTransactionResult](https://github.com/flashbots/suave-std/tree/main/src/suavelib/Suave.sol#L88)
...
### [SimulatedLog](https://github.com/flashbots/suave-std/tree/main/src/suavelib/Suave.sol#L99)
...
### [Withdrawal](https://github.com/flashbots/suave-std/tree/main/src/suavelib/Suave.sol#L110)
