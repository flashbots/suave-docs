...
Any thing between the `---` tags will be used for the meta data of the page
...
The links in this paragraph are being pulled from a list [a link][1] and another [link][2].
...
```md
<img src={require('../static/img/example-banner.png').default} alt="Example banner" />
```
