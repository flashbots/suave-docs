...
:::info You need to be [running SUAVE locally](/how-to/run-suave) in order for this script to function. :::

Inside your `suave-geth` repo, create a new file in `suave/devenv/cmd` called `transactions.go`:
