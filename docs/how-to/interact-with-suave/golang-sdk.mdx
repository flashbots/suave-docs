...
[suave-geth](https://github.com/flashbots/suave-geth) provides an SDK with a set of tools to interact with SUAVE, including deploying contracts, sending transactions, and waiting for transaction receipts.
...
- `executionNodeAddress`: The address of the execution node.
