...
You can also adapt any of this code to use the Rigil Testnet RPC, rather than your local development environment. All it requires is 
...
```go
var (
  // This address of the MEVM can stay the same
	exNodeEthAddr = common.HexToAddress("b5feafbdd752ad52afb7e1bd2e40432a485bbb7f")
