...
Once a SUAPP has emitted the result of a confidential computation, what happens? The next guide contains a more complete overview of [how data might flow if we replicate MEV-Share on SUAVE](/how-to/create-contracts/ofa).
