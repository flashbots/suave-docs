...
:::info [The code is here](https://github.com/flashbots/suave-geth/blob/main/suave/sol/standard_peekers/bids.sol#L65) if you want to run it yourself and develop your own picture of the total data flow in SUAVE. :::
...
:::info The term "bid" is an artefact of earlier versions of suave-geth. Here, it is a general data identifier used when operating on confidential data. :::
...
You can read more about exactly how the [Confidential Data Store works in the technical specs](/technical/specs/rigil/confidential-data-store).
