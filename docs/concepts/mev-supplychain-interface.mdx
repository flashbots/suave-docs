...
The Private OFA examples also illustrate how the confidential store, and the various on-chain interactions in enables, may be used to interface with **every aspect** of the supply chain, right from user intents to bundles and blocks.
